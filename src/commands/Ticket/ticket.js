...
import { createActionRowsFromButtons, getDefaultTicketButtons, sanitizeButtonConfig } from '../../utils/ticketPanelButtons.js';
    ...
    async execute(interaction, config, client) {
        try {
            ...
            if (subcommand === "setup") {
                ...
                // Use default ticket buttons
                const defaultButtons = getDefaultTicketButtons();
                const actionRows = createActionRowsFromButtons(defaultButtons);
                ...
                try {
                    ...
                    if (client.db && interaction.guildId) {
                        ...
                        // Store custom buttons (default for now)
                        currentConfig.ticketPanelButtons = defaultButtons.map(btn => sanitizeButtonConfig(btn));
                        ...
                        logger.info('Ticket configuration saved', {
                            ...
                            dmOnClose: dmOnClose,
                            buttonCount: defaultButtons.length
                        });
                    }
